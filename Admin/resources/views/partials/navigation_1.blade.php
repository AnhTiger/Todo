<div class="nk-sidebar nk-sidebar-fixed" data-content="sidebarMenuGloabl">
  <div class="nk-sidebar-element nk-sidebar-head">
    <div class="nk-menu-trigger">
      @persist('navKeepLoadingLoading1')
    ...
    <div class="nk-sidebar-brand ">
      @persist('navKdeeaddfdfsdsfddoadingLoading2')
    ...
    <div class="nk-sidebar-content">
      <div class="nk-sidebar-menu" data-simplebar="init">
        <div class="simplebar-wrapper" style="margin: -16px 0px -40px;">
          ...
          <div class="simplebar-placeholder" style="width: auto; height: 1634px;"></div>
        </div>
        <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;">
          <div class="simplebar-scrollbar" style="width: 0px; display: none;"></div>
        </div>
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
          <div class="simplebar-scrollbar" style="height: 446px; transform: translate3d(0px, 104px, 0px); display: block;"></div>
        </div>
      </div>
    </div>
  </div>
