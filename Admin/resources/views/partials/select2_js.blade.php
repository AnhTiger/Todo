...
<script>
    $(document).ready(function() {
        ...
        $('.action-modal-select2').on('change', function (e) {
        ...
        $('.action-modal-select2-tooltip').select2(
            {
                allowClear: true,
        ...
        $('.action-modal-select2-tooltip').on('change', function (e) {
            let data = $(this).select2("val");
            let nameSelect = $(this).attr('wire:model.lazy');
            if(!(nameSelect == null ||nameSelect == "undefined" ||nameSelect == "")){
                @this.set(nameSelect, data);
